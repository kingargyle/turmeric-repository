...
public class GetAssetInfoConsumer extends BaseRepositoryServiceConsumer {
    ...
    * // results.put("testGetAssetInfo_invalidAssetVersion_forpublished",
    * testGetAssetInfo_forpublished("invalidAssetVersion")); //
    * results.put("testGetAssetInfo_invalidAssetType_forpublished", testGetAssetInfo_forpublished("invalidAssetType"));
    * // results.put("testGetAssetInfo_insufficientPrivilege_forpublished",
    * testGetAssetInfo_forpublished("insufficientPrivilege")); //
    * results.put("testGetAssetInfo_fromDifferentlibraries_validAsset_forpublished",
    * testGetAssetInfo_fromDifferentlibraries_validAsset_forpublished()); // results.put("testGetAssetInfo_validAsset",
    * testGetAssetInfo_validAsset()); // results.put("testGetAssetInfo_validAsset_byName",
    * testGetAssetInfo_validAsset_byName()); // results.put("testGetAssetInfo_invalidAssetKey",
    * testGetAssetInfo("invalidAssetKey")); // results.put("testGetAssetInfo_invalidAssetVersion",
    * testGetAssetInfo("invalidAssetVersion")); // results.put("testGetAssetInfo_invalidAssetType",
    * testGetAssetInfo("invalidAssetType")); // results.put("testGetAssetInfo_insufficientPrivilege",
    * testGetAssetInfo("insufficientPrivilege")); // results.put("testGetAssetInfo_fromDifferentlibraries_validAsset",
    * testGetAssetInfo_fromDifferentlibraries_validAsset());
    * 
    * 
    * 
    * 
    * 
    * System.out.println("\ngetAssetInfo Summary"); Set<String> methods = results.keySet(); int i = 1; for (String
    * method : methods) { System.out.format("%d %-60s: %s\n",i, method, results.get(method)); i++; }
    * System.out.println(); }
    * 
    * public static Map<String, String> testGetAssetInfo() { Map<String, String> results = new HashMap<String,
    * String>();
    * 
    ...
    * results.put("testGetAssetInfo_fromDifferentlibraries_validAsset",
    * testGetAssetInfo_fromDifferentlibraries_validAsset()); return results; }
    */
   public static String testGetAssetInfo_fromDifferentlibraries_validAsset(AssetInfo governedAssetInfo,
      ...
      /*
       * AssetKey assetKey2 = new AssetKey(); //assetKey2.setAssetId(RepositoryServiceClientConstants.ASSET_ID2);
       * assetKey2.setAssetName(RepositoryServiceClientConstants.ASSET_NAME2); assetKey2.setLibrary(library2);
       */
      ...
      try {
         ...
         /*
          * GetAssetInfoResponse getAssetInfoResponse2 =
          * getAssetInfoConsumer.getProxy().getAssetInfo(getAssetInfoRequest2);
          * 
          * 
          * if(getAssetInfoResponse2 == null) { throw new ServiceException(null, "Response object can not be null",
          * null); } if(getAssetInfoResponse2!= null&& getAssetInfoResponse2.getAssetInfo()!= null) { AssetInfo
          * assetInfo = getAssetInfoResponse2.getAssetInfo(); BasicAssetInfo basicAssetInfo =
          * assetInfo.getBasicAssetInfo(); System.out.println();
          * System.out.println("Basic Asset information of the asset '" + assetKey.getAssetName() + "' is as follows");
          * System.out.println("AssetType             : " + basicAssetInfo.getAssetType());
          * System.out.println("Asset Description     : " + basicAssetInfo.getAssetDescription());
          * System.out.println("Asset long description: " + basicAssetInfo.getAssetLongDescription());
          * System.out.println("Asset version         : " + basicAssetInfo.getVersion()); System.out.println();
          * 
          * if(!returnString.equals("FAILED")) { returnString = "PASSED"; } } else { returnString = "FAILED"; }
          */
