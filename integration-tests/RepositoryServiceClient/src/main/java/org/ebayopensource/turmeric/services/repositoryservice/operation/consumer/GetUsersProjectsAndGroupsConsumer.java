...
public class GetUsersProjectsAndGroupsConsumer extends BaseRepositoryServiceConsumer{
	...
	public static String testGetUsersProjectsAndGroupsWithValidLibrary() {
		...
		try {
			GetUsersProjectsAndGroupsResponse getUsersProjectsAndGroupsResponse = getUsersProjectsAndGroupsConsumer.getProxy().getUsersProjectsAndGroups(getUsersProjectsAndGroupsRequest);
			if(getUsersProjectsAndGroupsResponse == null) {
				throw new ServiceException(null, "Response object can not be null", null);
			}
			
			if(validateGetUsersProjectsAndGroupsResponse(getUsersProjectsAndGroupsResponse, "positiveCase").equalsIgnoreCase("success")) {	
	...
	public static String testGetUsersProjectsAndGroupsWithInvalidLibrary() {
		...
		try {
			GetUsersProjectsAndGroupsResponse getUsersProjectsAndGroupsResponse = getProjectsAndGroupsConsumer.getProxy().getUsersProjectsAndGroups(getUsersProjectsAndGroupsRequest);
			if(getUsersProjectsAndGroupsResponse == null) {
				throw new ServiceException(null, "Response object can not be null", null);
			}
			
			if(validateGetUsersProjectsAndGroupsResponse(getUsersProjectsAndGroupsResponse, "negativeCase").equalsIgnoreCase("success")) {	
				return RepositoryServiceClientConstants.PASS;
			}
			else {			
				return RepositoryServiceClientConstants.FAIL;
    ...
    private static String validateGetUsersProjectsAndGroupsResponse(GetUsersProjectsAndGroupsResponse getUsersProjectsAndGroupsResponse, String criteria) {
