...
public class UpdateCompleteAssetConsumer extends BaseRepositoryServiceConsumer {
    ...
    * 
    * 
    * results.put("testUpdateCompleteAsset_withAllOptionalInputParams",
    * testUpdateCompleteAsset_validInput("withAllOptionalInputParams"));
    * 
    * results.put("testUpdateCompleteAsset_noRequest", testUpdateCompleteAsset_invalidInput("noRequest"));
    * results.put("testUpdateCompleteAsset_invalidLibraryName",
    * testUpdateCompleteAsset_invalidInput("invalidLibraryName"));
    ...
    * 
    * System.out.println("\n updateCompleteAsset Summary"); Set<String> methods = results.keySet(); for (String method :
    * methods) { System.out.format("%-60s: %s\n", method, results.get(method)); } System.out.println(); }
    * 
    * public static Map<String, String> testCreateAsset() { Map<String, String> results = new HashMap<String, String>();
    * 
    * results.put("testUpdateCompleteAsset_withAllOptionalInputParams",
    * testUpdateCompleteAsset_validInput("withAllOptionalInputParams"));
    * 
   ...
   public static String testUpdateCompleteAsset_validInput(String variant, AssetInfo assetInfo,
      ...
      library1.setLibraryId(assetInfo.getFlattenedRelationship().getRelatedAsset().get(0).getTargetAsset().getLibrary()
               .getLibraryId());
      library1.setLibraryName(assetInfo.getFlattenedRelationship().getRelatedAsset().get(0).getTargetAsset()
