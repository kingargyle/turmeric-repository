...
public class UpdateAssetDependenciesByGraphConsumer extends BaseRepositoryServiceConsumer {
   private AsyncTurmericRSV1 m_proxy = null;

   public static String testUpdateAssetDependenciesByGraph_validInput(AssetInfo sourceAssetInfo,
            AssetInfo targetAsset1Level1Info, AssetInfo targetAsset2Level1Info, AssetInfo targetAsset1Level2Info) {
      ...
      try {
         UpdateAssetDependenciesByGraphResponse updateAssetDependenciesByGraphResponse = updateAssetDependenciesByGraphConsumer
                  .getProxy().updateAssetDependenciesByGraph(updateAssetDependenciesByGraphRequest);
         if (updateAssetDependenciesByGraphResponse == null) {
            throw new ServiceException(null, "Response object can not be null", null);
         }
         if (updateAssetDependenciesByGraphResponse.getAck().value()
                  .equalsIgnoreCase(RepositoryServiceClientConstants.SUCCESS)) {
            return RepositoryServiceClientConstants.PASS;
         } else if (updateAssetDependenciesByGraphResponse.getAck().value()
   ...
   public static String testUpdateAssetDependenciesByGraph_invalidInput(String variant, AssetInfo sourceAssetInfo,
            AssetInfo targetAsset1Level1Info, AssetInfo targetAsset2Level1Info, AssetInfo targetAsset1Level2Info) {
      UpdateAssetDependenciesByGraphConsumer updateAssetDependenciesByGraphConsumer = new UpdateAssetDependenciesByGraphConsumer();
      UpdateAssetDependenciesByGraphRequest updateAssetDependenciesByGraphRequest = new UpdateAssetDependenciesByGraphRequest();
