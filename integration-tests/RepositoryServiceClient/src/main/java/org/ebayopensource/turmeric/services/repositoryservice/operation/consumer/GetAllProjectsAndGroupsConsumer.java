...
public class GetAllProjectsAndGroupsConsumer extends BaseRepositoryServiceConsumer{
	...
	public static String testGetAllProjectsAndGroupsWithValidLibrary() {
		...
		try {
			GetAllProjectsAndGroupsResponse getAllProjectsAndGroupsResponse = getAllProjectsAndGroupsConsumer.getProxy().getAllProjectsAndGroups(getAllProjectsAndGroupsRequest);
			if(getAllProjectsAndGroupsResponse == null) {
				throw new ServiceException(null, "Response object can not be null", null);
			}
			
			if(validateGetAllProjectsAndGroupsResponse(getAllProjectsAndGroupsResponse, "positiveCase").equalsIgnoreCase("success")) {	
	...
	public static String testGetAllProjectsAndGroupsWithInvalidLibrary() {
		...
		try {
			GetAllProjectsAndGroupsResponse getAllProjectsAndGroupsResponse = getProjectsAndGroupsConsumer.getProxy().getAllProjectsAndGroups(getAllProjectsAndGroupsRequest);
			if(getAllProjectsAndGroupsResponse == null) {
				throw new ServiceException(null, "Response object can not be null", null);
			}
			
			if(validateGetAllProjectsAndGroupsResponse(getAllProjectsAndGroupsResponse, "negativeCase").equalsIgnoreCase("success")) {	
				return RepositoryServiceClientConstants.PASS;
			}
			else {			
				return RepositoryServiceClientConstants.FAIL;
    ...
    private static String validateGetAllProjectsAndGroupsResponse(GetAllProjectsAndGroupsResponse getAllProjectsAndGroupsResponse, String criteria) {
