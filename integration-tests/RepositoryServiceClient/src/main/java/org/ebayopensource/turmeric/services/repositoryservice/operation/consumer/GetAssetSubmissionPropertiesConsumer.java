...
public class GetAssetSubmissionPropertiesConsumer extends BaseRepositoryServiceConsumer{
	...
	public static String testGetAssetSubmissionProperties_UnlockedAsset(AssetInfo assetInfo) {
		...
		assetKey.setLibrary(library);assetKey.setLibrary(library);
		...
		try {
			GetAssetSubmissionPropertiesResponse getAssetSubmissionPropertiesResponse = getAssetSubmissionPropertiesConsumer.getProxy().getAssetSubmissionProperties(getAssetSubmissionPropertiesRequest);
			if(getAssetSubmissionPropertiesResponse == null) {
				throw new ServiceException(null, "Response object can not be null", null);
			}
			
			if(validateGetAssetSubmissionPropertiesResponse(getAssetSubmissionPropertiesResponse, "positiveCase").equalsIgnoreCase("success")) {	
	...
	public static String testGetAssetSubmissionProperties_WithoutAssetId() {
		...
		try {
			...
			if(validateGetAssetSubmissionPropertiesResponse(getAssetSubmissionPropertiesResponse, "negativeCase").equalsIgnoreCase("success")) {	
				return RepositoryServiceClientConstants.PASS;
			}
			else {			
				return RepositoryServiceClientConstants.FAIL;
	...
	public static String testGetAssetSubmissionProperties_WithInvalidLibrary() {
		...
		Library library = new Library();
		library.setLibraryId(RepositoryServiceClientConstants.LIBRARY_ID);
		library.setLibraryName("InvalidLib");
		assetKey.setLibrary(library);
		getAssetSubmissionPropertiesRequest.setAssetKey(assetKey);
	...
	private static String validateGetAssetSubmissionPropertiesResponse(GetAssetSubmissionPropertiesResponse getAssetSubmissionPropertiesResponse, String criteria) {
