...
public class SearchAssetConsumer extends BaseRepositoryServiceConsumer {
   ...
   public static void main(String[] args) {
      ...
      // results.put("testSearchAsset_Without_AttributeCriteria_withLibrary",
      // testSearchAsset_Without_AttributeCriteria_withLibrary());
      // bootstrap results.put("testSearchAsset_Without_AttributeCriteria_withoutLibrary",
      // testSearchAsset_Without_AttributeCriteria_withoutLibrary());
   ...
   public static String testSearchAsset_withLibrary_andConjunction_relationCriteria() {
      ...
      /*
       * Attribute attribute2 = new Attribute(); attribute2.setAttributeName("asset-type");
       * attribute2.setAttributeValue("Service"); attributeCriteria.getAttribute().add(attribute2);
       */
