...
import org.ebayopensource.turmeric.repository.v1.services.RelationshipCriteria;
import org.ebayopensource.turmeric.repository.v1.services.RelationshipCriterion;
...
public class SearchAssetConsumer extends BaseRepositoryServiceConsumer {
	...
	public static void main(String[] args) {		
		...
		results.put("testSearchAsset_withLibrary_andConjunction_relationCriteria",    testSearchAsset_withLibrary_andConjunction_relationCriteria());
      //null	results.put("testSearchAsset_withLibrary_andConjunction",    testSearchAsset_withLibrary_andConjunction());
      	//results.put("testSearchAsset_Without_AttributeCriteria_withLibrary",    testSearchAsset_Without_AttributeCriteria_withLibrary());
      	// bootstrap results.put("testSearchAsset_Without_AttributeCriteria_withoutLibrary",    testSearchAsset_Without_AttributeCriteria_withoutLibrary());
      	//results.put("testSearchAsset_with_SingleAttribute_Criteria",    testSearchAsset_with_SingleAttribute_Criteria());
      	//results.put("testSearchAsset_withLibrary_orConjunction",           testSearchAsset_withLibrary_orConjunction());
      	//results.put("testSearchAsset_withoutLibrary_andConjunction",       testSearchAsset_withoutLibrary_andConjunction());
      	//results.put("testSearchAsset_withoutLibrary_orConjunction",        testSearchAsset_withoutLibrary_orConjunction());
	...
	public static String testSearchAsset_withLibrary_andConjunction_relationCriteria() 
	{
		...
		library.setLibraryName("GovernedAssets");
		...
		attribute2.setAttributeValue("Service");
		...
		try	{
			...
			if(validateSearchAssetsResponse(searchAssetsResponse, "positiveCase").equalsIgnoreCase(RepositoryServiceClientConstants.SUCCESS)) {							
	...
	public static String testSearchAsset_Without_AttributeCriteria_withoutLibrary()
	{
		...
		try	{
			...
			if(validateSearchAssetsResponse(searchAssetsResponse,RepositoryServiceClientConstants.PARTIAL_CASE).equalsIgnoreCase(RepositoryServiceClientConstants.SUCCESS)) {							
				return RepositoryServiceClientConstants.PASS;
			}
			else {
				return RepositoryServiceClientConstants.FAIL;
