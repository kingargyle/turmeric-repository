...
public class UpdateAssetArtifactsConsumer extends BaseRepositoryServiceConsumer {
   ...
   public static String testUpdateAssetArtifacts_validAsset(AssetInfo assetInfo) {
      ...
      try {
         UpdateAssetArtifactsResponse updateAssetArtifactsResponse = updateAssetArtifactsConsumer.getProxy()
         ...
         if (validateUpdateAssetArtifactsResponse(updateAssetArtifactsResponse, "positiveCase").equalsIgnoreCase(
                  "success")) {
            return "PASSED";
         } else {
            return "FAILED";
   ...
   public static String testUpdateAssetArtifacts_invalidArtifactId(AssetInfo assetInfo) {
      ...
      try {
         ...
         if (validateUpdateAssetArtifactsResponse(updateAssetArtifactsResponse, "negativeCase").equalsIgnoreCase(
                  "success")) {
            return "PASSED";
         } else {
            return "FAILED";
   ...
   private static String validateUpdateAssetArtifactsResponse(
            UpdateAssetArtifactsResponse updateAssetArtifactsResponse, String criteria) {
      if (criteria.equalsIgnoreCase("positiveCase")) {
         if (updateAssetArtifactsResponse.getAck().value().equalsIgnoreCase(RepositoryServiceClientConstants.SUCCESS)) {
            ...
            for (Artifact artifact : artifacts) {
               if (RepositoryServiceConsumerUtil.validateArtifact(artifact).equalsIgnoreCase(
      ...
      if (criteria.equalsIgnoreCase("negativeCase")) {
         ...
         if (updateAssetArtifactsResponse.getAck().value()
