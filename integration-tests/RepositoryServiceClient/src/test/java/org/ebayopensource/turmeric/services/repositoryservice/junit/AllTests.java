...
// CreateAndSubmitTest.class,
         CreateAssetTest.class, CreateCompleteAssetTest.class,
         ...
         UnlockAssetTest.class, UpdateAssetArtifactTest.class, UpdateAssetAttributesTest.class,
         // UpdateAssetDependenciesByGraphTest.class,
         // UpdateAssetDependenciesTest.class,
         UpdateAssetTest.class, UpdateCompleteAssetTest.class
// UpdateServiceTest.class,
// ValidateAssetTest.class
})
public class AllTests {
   static {
      System.setProperty("javax.net.ssl.trustStore", new File("client-truststore.jks").getAbsolutePath());
