...
public class GetAssetDependenciesConsumer extends BaseRepositoryServiceConsumer {
   ...
   public static String testGetAssetDependencies_validAsset(AssetInfo assetInfo) {
      ...
      try {
         ...
         GetAssetDependenciesResponse getAssetDependenciesResponse = getAssetDependenciesConsumer.getProxy()
         ...
         if (validateGetAssetDependenciesResponse(getAssetDependenciesResponse, "positiveCase").equalsIgnoreCase(
                  "success")) {
   ...
   public static String testGetAssetDependencies_invalidAsset() {
      ...
      try {
         ...
         if (validateGetAssetDependenciesResponse(getAssetDependenciesResponse, "negativeCase").equalsIgnoreCase(
                  "success")) {
   ...
   private static String validateGetAssetDependenciesResponse(
            GetAssetDependenciesResponse getAssetDependenciesResponse, String criteria) {
