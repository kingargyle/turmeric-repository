...
public class UpdateCompleteAssetTest {
	 ...
	 * Method under test: updateCompleteAsset
	 * Test Type        : Negative
	 * Sub  Type        : InvalidInput no request
	 */
	...
	public void testUpdateCompleteAsset_InvalidInput_noRequest() throws Exception {
		try
		{
		String status = UpdateCompleteAssetConsumer.testUpdateCompleteAsset_invalidInput
															("noRequest",serviceAssetInfo,fdAssetInfo);
	...
	public void testUpdateCompleteAsset_invalidInput_inValidGroupName() throws Exception {
		...
		{
			String status = UpdateCompleteAssetConsumer.testUpdateCompleteAsset_invalidInput
													("inValidGroupName",serviceAssetInfo,fdAssetInfo);
	 ...
	 * Method under test: updateCompleteAsset
	 * Test Type        : Negative
	 * Sub  Type        : InvalidInput Invalid library
	 */
	@Test
	public void testUpdateCompleteAsset_InvalidInput_invalidLibrary() throws Exception {
		...
		{
			String status = UpdateCompleteAssetConsumer.testUpdateCompleteAsset_invalidInput
													("inValidLibraryName",serviceAssetInfo,fdAssetInfo);
	 ...
	 * Method under test: updateCompleteAsset
	 * Test Type        : Negative
	 * Sub  Type        : InvalidInput Invalid Asset ID
	 */
	@Test
	public void testUpdateCompleteAsset_InvalidInput_invalidAssetID() throws Exception {
		try
		{
			...
			String status = UpdateCompleteAssetConsumer.testUpdateCompleteAsset_invalidInput
													("inValidAssetId",serviceAssetInfo,fdAssetInfo);
