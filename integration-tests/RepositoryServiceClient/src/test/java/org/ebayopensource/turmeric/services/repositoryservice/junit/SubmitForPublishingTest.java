...
public class SubmitForPublishingTest {
   ...
   /*
    * Method under test: submitForPublishing Test Type : Positive Sub Type : validAsset locked
    */
   @Test
   ...
   /*
    * Method under test: submitForPublishing Test Type : Positive Sub Type : validAsset unlocked
    */@Test
   ...
   /*
    * Method under test: submitForPublishing Test Type : Negative Sub Type : invalidLogin
    */
   @Test
   ...
   /*
    * Method under test: submitForPublishing Test Type : Positive Sub Type : validAsset_lockedForEdit
    */
   @Test
   ...
   /*
    * Method under test: submitForPublishing Test Type : Positive Sub Type : emptyHeader
    */
   @Test
   ...
   /*
    * Method under test: submitForPublishing Test Type : Positive Sub Type : inValidSession
    */
   @Test
   ...
   /*
    * Method under test: submitForPublishing Test Type : Positive Sub Type : incompleteAsset
    */
   @Test
   ...
   /*
    * Method under test: submitForPublishing Test Type : Positive Sub Type : EmptyAsset
    */
   @Test
   ...
   /*
    * Method under test: submitForPublishing Test Type : Positive Sub Type : withoutLibraryName
    */
   @Test
