...
public class GetAssetDependencyTest {
    ...
    */
   @Test
   public void testGetAssetDependencies_withoutSpecifyingDepth_positive() throws AssetInfoNotFoundException,
            IdNotFoundException {
      try {
    ...
    */
   @Test
   public void testGetAssetDependencies_untillSpecifiedDepth_positive() throws AssetInfoNotFoundException,
            IdNotFoundException {
      try {
         AssetInfo assetInfo = assetCreator.getAssetAsAssetInfo("Common");
