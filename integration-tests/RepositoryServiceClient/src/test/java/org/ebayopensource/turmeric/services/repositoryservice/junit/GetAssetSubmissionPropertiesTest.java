...
public class GetAssetSubmissionPropertiesTest {
   ...
   /*
    * Method under test: GetAssetSubmissionProperties Test Type : Positive Sub Type : assetCurrentlyUnlocked
    */
   @Test
   ...
   /*
    * Method under test: GetAssetSubmissionProperties Test Type : Positive Sub Type : assetCurrentlylocked
    */
   ...
   /*
    * Method under test: GetAssetSubmissionProperties Test Type : Negative Sub Type : EmptyRequest
    */
   @Test
   ...
   /*
    * Method under test: GetAssetSubmissionProperties Test Type : Negative Sub Type : EmptyLibrary
    */
   @Test
   ...
   /*
    * Method under test: GetAssetSubmissionProperties Test Type : Negative Sub Type : WithoutAssetKey
    */
   @Test
   ...
   /*
    * Method under test: GetAssetSubmissionProperties Test Type : Negative Sub Type : WithInvalidLibrary
    */
   @Test
   ...
   /*
    * Method under test: GetAssetSubmissionProperties Test Type : Negative Sub Type : WithoutAssetId
    */
   @Test
   ...
   /*
    * Method under test: GetAssetSubmissionProperties Test Type : Negative Sub Type : WithInvalidAssetId
    */
   @Test
