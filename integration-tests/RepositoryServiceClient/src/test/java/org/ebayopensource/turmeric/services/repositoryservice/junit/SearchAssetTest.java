...
public class SearchAssetTest {
   ...
   /*
    * NULL Method under test: SearchAsset Test Type : Positive Sub Type : with Library argument , using the AND
    * Conjunction
    */
   @Test
   ...
   /*
    * FINE Method under test: SearchAsset Test Type : Positive Sub Type : with Library argument , using the OR
    * Conjunction
    */
   @Test
   ...
   /*
    * Method under test: SearchAsset Test Type : Positive Sub Type : withLibrary_andConjunction_relationCriteria
    */
   @Test
   ...
   /*
    * Method under test: SearchAsset Test Type : Positive Sub Type : Without_AttributeCriteria_withLibrary
    */
   @Test
   ...
   /*
    * BOOTSTRAP USER Method under test: SearchAsset Test Type : Positive Sub Type :
    * Without_AttributeCriteria_withoutLibrary
    */
   @Test
   ...
   /*
    * Method under test: SearchAsset Test Type : Positive Sub Type : with_SingleAttribute_Criteria
    */
   @Test
