...
public class UpdateAssetArtifactTest {
   ...
   /*
    * Method under test: updateAssetArtifacts Test Type : Negative Sub Type : InvalidArtifactId
    */
   @Test
   ...
   /*
    * Method under test: updateAssetArtifacts Test Type : Negative Sub Type : noArtifactValueType
    */
   @Test
   ...
   /*
    * Method under test: updateAssetArtifacts Test Type : Negative Sub Type : noArtifactName
    */
   @Test
   ...
   /*
    * Method under test: updateAssetArtifacts Test Type : Negative Sub Type : noArtifactCategory
    */
   @Test
   ...
   /*
    * Method under test: updateAssetArtifacts Test Type : Negative Sub Type : noArtifactDetail
    */
   @Test
