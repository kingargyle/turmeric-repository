...
public class SearchAssetsDetailedConsumer extends BaseRepositoryServiceConsumer {
   ...
   public static String testSearchAssetsDetailed_withoutSearchLevel() {
      ...
      try {
         SearchAssetsDetailedResponse searchAssetsResponse = searchAssetsDetailedConsumer.getProxy()
                  .searchAssetsDetailed(searchAssetsRequest);
         ...
         if (validateSearchAssetsDetailedResponse(searchAssetsResponse, "positiveCase").equalsIgnoreCase(
   ...
   private static String validateSearchAssetsDetailedResponse(
            SearchAssetsDetailedResponse searchAssetsDetailedResponse, String criteria) {
      ...
      if (criteria.equalsIgnoreCase(RepositoryServiceClientConstants.PARTIAL_CASE)) {
         if (searchAssetsDetailedResponse.getAck().value()
   ...
   private static SearchAssetsDetailedRequest getSearchAssetsDetailedRequest() {
      ...
      /*
       * Attribute attribute1 = new Attribute(); attribute1.setAttributeName("asset-name");
       * attribute1.setAttributeValue("TestInternalService1"); attributeCriteria.getAttribute().add(attribute1);
       */
