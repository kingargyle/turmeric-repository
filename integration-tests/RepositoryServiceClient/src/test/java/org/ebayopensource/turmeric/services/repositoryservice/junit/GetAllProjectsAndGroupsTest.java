...
public class GetAllProjectsAndGroupsTest {
   ...
   /*
    * Method under test: GetAllProjectsAndGroups Test Type : Negative Sub Type : invalidLibrary
    */
   ...
   /*
    * Method under test: GetAllProjectsAndGroups Test Type : Positive Sub Type : ValidLibraryId
    */
   ...
   /*
    * Method under test: GetAllProjectsAndGroups Test Type : Negative Sub Type : Without Library
    */
   ...
   /*
    * Method under test: GetAllProjectsAndGroups Test Type : Positive Sub Type : With Empty Request
    */
   ...
   /*
    * Method under test: GetAllProjectsAndGroups Test Type : Positive Sub Type : With Empty Library
    */
