...
public class GetAssetVersionsTest {
   ...
   /*
    * Method under test: getAssetVersions Test Type : Positive Sub Type : invalidAsset
    */
   @Test
   ...
   /*
    * Method under test: getAssetVersions Test Type : Positive Sub Type : With all input params
    */
   @Test
   ...
   /*
    * Method under test: getAssetVersions Test Type : Positive Sub Type : Without library ID
    */
   @Test
   ...
   /*
    * Method under test: getAssetVersions Test Type : Negative Sub Type : invalidAssetName
    */
   @Test
   ...
   /*
    * Method under test: getAssetVersions Test Type : Negative Sub Type : No asset Id , no asset name
    */
   @Test
   ...
   /*
    * Method under test: getAssetVersions Test Type : Negative Sub Type : no library
    */
   @Test
   ...
   /*
    * Method under test: getAssetVersions Test Type : Negative Sub Type : No library ID, No Library name
    */
   @Test
   public void testGetAssetVersions_noLibraryIdAndNoLibraryName_negative() throws Exception {
      try {
         AssetInfo assetInfo = assetCreator.getAssetAsAssetInfo("Common");
         String status = GetAssetVersionsConsumer.testGetAssetVersions_validInput("noLibraryIdAndNoLibraryName",
                  assetInfo);
         Assert.assertEquals(s_success, status);
         AssetKey assetKey = new AssetKey();
         assetKey.setAssetId(assetInfo.getBasicAssetInfo().getAssetKey().getAssetId());
   ...
   /*
    * Method under test: getAssetVersions Test Type : Negative Sub Type : invalidLibrary
    */
   @Test
