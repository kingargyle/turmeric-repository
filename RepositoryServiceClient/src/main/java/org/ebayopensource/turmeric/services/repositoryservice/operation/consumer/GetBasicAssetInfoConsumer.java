...
public class GetBasicAssetInfoConsumer extends BaseRepositoryServiceConsumer {
	...
	public static String testGetBasicAssetInfo_validAsset(AssetInfo assetInfo) {
		...
		String libraryName = assetKey.getLibrary().getLibraryName();
		...
		try	
		{
			GetBasicAssetInfoResponse getBasicAssetInfoResponse = getBasicAssetInfoConsumer.getProxy().
																			getBasicAssetInfo(getBasicAssetInfoRequest);
	...
	public static String testGetBasicAssetInfo_insufficientPrivilege() {
		...
		try	{
			GetBasicAssetInfoResponse getBasicAssetInfoResponse = getBasicAssetInfoConsumer.getProxy().getBasicAssetInfo(getBasicAssetInfoRequest);
    ...
    private static String validateGetBasicAssetInfoResponse(GetBasicAssetInfoResponse getBasicAssetInfoResponse, String criteria) {
