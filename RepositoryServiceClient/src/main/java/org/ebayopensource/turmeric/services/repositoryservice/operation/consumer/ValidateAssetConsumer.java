...
public class ValidateAssetConsumer extends BaseRepositoryServiceConsumer{
	...
	private static final String LIBRARY_ID= "352:5";
	...
	private static final String DT_ASSET_ID= "1.0_1240325238934-1367998591";
	private static final String DT_ASSET_NAME= "ValidationErrorData";
	private static final String DT_VERSION= "1.0.0";
	...
	public static String testValidateServiceAsset_withValidAsset() {
		...
		try {
			ValidateAssetResponse validateAssetResponse = validateAssetConsumer.getProxy().validateAsset(validateAssetRequest);
