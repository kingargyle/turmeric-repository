...
public class CommonUtil {
	...
	public static AssetKey createCompleteServiceAsset()
	{
		...
		try 
		{
			CreateCompleteAssetResponse createCompleteAssetResponse = rsConsumer.getProxy().createCompleteAsset(createCompleteAssetRequest);
	...
	public static void removeAsset(AssetKey assetKey)
	{
		...
		try {
			RemoveAssetResponse removeAssetResponse = rsConsumer.getProxy().removeAsset(removeAssetRequest);
		} catch (ServiceException e) {
			e.printStackTrace();
		} catch(Exception e) {
			e.printStackTrace();
	...
	public static void unLockAsset(AssetKey assetKey)
	{
		...
		try {
			UnlockAssetResponse unlockAssetResponse = rsConsumer.getProxy().unlockAsset(unlockAssetRequest);
		} catch (ServiceException e) {
			e.printStackTrace();
		} catch(Exception e) {
			e.printStackTrace();
	...
	public static void lockAsset(AssetKey assetKey)
	{
		...
		try {
			LockAssetResponse lockAssetResponse = rsConsumer.getProxy().lockAsset(lockAssetRequest);
		} catch (ServiceException e) {
			e.printStackTrace();
		} catch(Exception e) {
			e.printStackTrace();
	...
	public static void lockAsset(AssetKey assetKey, String userId, String password)
	{
		...
		try {
			LockAssetResponse lockAssetResponse = rsConsumer.getProxy(userId, password).lockAsset(lockAssetRequest);
		} catch (ServiceException e) {
			e.printStackTrace();
		} catch(Exception e) {
			e.printStackTrace();
