...
public class RepositoryServiceConsumerUtil {
	public static String validateAssetInfo(AssetInfo assetInfo) {		
		...
		if(assetInfo.getAssetLifeCycleInfo() != null) {
			if(validateAssetLifeCycleInfo(assetInfo.getAssetLifeCycleInfo()).equalsIgnoreCase(RepositoryServiceClientConstants.FAILURE)) {
				return RepositoryServiceClientConstants.FAILURE;
			}
		}
		if(validateBasicAssetInfo(assetInfo.getBasicAssetInfo()).equalsIgnoreCase(RepositoryServiceClientConstants.FAILURE)) {
			return RepositoryServiceClientConstants.FAILURE;
		}
		if(assetInfo.getExtendedAssetInfo() != null) {
			if(validateExtendedAssetInfo(assetInfo.getExtendedAssetInfo()).equalsIgnoreCase(RepositoryServiceClientConstants.FAILURE)) {
				return RepositoryServiceClientConstants.FAILURE;
			}
		}
		if(assetInfo.getFlattenedRelationship() != null) {
			if(validateFlattenedRelationship(assetInfo.getFlattenedRelationship()).equalsIgnoreCase(RepositoryServiceClientConstants.FAILURE)) {
				return RepositoryServiceClientConstants.FAILURE;				
			}
		}
	...
	public static String validateServiceInfo(ServiceInfo serviceInfo) {
		...
		if(validateBasicServiceInfo(serviceInfo.getBasicServiceInfo()).equalsIgnoreCase(RepositoryServiceClientConstants.FAILURE)) {
			return RepositoryServiceClientConstants.FAILURE;
		}
		...
		if(serviceInfo.getAssetLifeCycleInfo() != null) {
			if(validateAssetLifeCycleInfo(serviceInfo.getAssetLifeCycleInfo()).equalsIgnoreCase(RepositoryServiceClientConstants.FAILURE)) {
				return RepositoryServiceClientConstants.FAILURE;
			}
		}
		if(serviceInfo.getFlattenedRelationship() != null) {
			if(validateFlattenedRelationship(serviceInfo.getFlattenedRelationship()).equalsIgnoreCase(RepositoryServiceClientConstants.FAILURE)) {
				return RepositoryServiceClientConstants.FAILURE;
			}
		}
	...
	public static String validateBasicServiceInfo(BasicServiceInfo basicServiceInfo) {
		...
		if(basicServiceInfo.getAssetKey() != null) {
			if(validateAssetKey(basicServiceInfo.getAssetKey()).equalsIgnoreCase(RepositoryServiceClientConstants.FAILURE)) {
				return RepositoryServiceClientConstants.FAILURE;
			}			
		}
		if(basicServiceInfo.getServiceDescription() == null || basicServiceInfo.getServiceName() == null ||  basicServiceInfo.getServiceVersion() == null) {
			return RepositoryServiceClientConstants.FAILURE;
		}
	...
	public static String validateArtifact(Artifact artifact) {
		if(artifact == null || artifact.getArtifactCategory() == null || artifact.getArtifactIdentifier()== null || artifact.getArtifactName() == null) {
			return RepositoryServiceClientConstants.FAILURE;
		}	
	...
	public static String validateBasicAssetInfo(BasicAssetInfo basicAssetInfo) {
		if(basicAssetInfo.getAssetType() == null || basicAssetInfo.getAssetName() == null || basicAssetInfo.getAssetDescription() == null || basicAssetInfo.getVersion() == null) {
			return RepositoryServiceClientConstants.FAILURE;
		}
	...
	public static String validateFlattenedRelationship(FlattenedRelationship flattenedRelationship) {
		if(validateAssetKey(flattenedRelationship.getSourceAsset()).equalsIgnoreCase(RepositoryServiceClientConstants.FAILURE)) {
			return RepositoryServiceClientConstants.FAILURE;
		}
	...
	public static String validateAssetStatus(AssetStatus assetStatus) {
		if(assetStatus.getAssetSubmissionTime() == null || assetStatus.getLastActivity() == null || assetStatus.getLastUpdateTime() == null || assetStatus.getState() == null /*|| assetStatus.getReviewer() == null || assetStatus.getReviewer().getRole() == null*/) {
			return RepositoryServiceClientConstants.FAILURE;
		}
		return RepositoryServiceClientConstants.SUCCESS;
	}	
	...
	public static String validateAssetBaseInfo(AssetBaseInfo assetBaseInfo) {
		if(assetBaseInfo != null) {
			if(assetBaseInfo.getAssetVersion() == null || assetBaseInfo.getAssetDescription() == null || assetBaseInfo.getAssetKey() == null) {
				return RepositoryServiceClientConstants.FAILURE;
			}else{
	...
	public static String validateAssetsGroupedByCategory(AssetsGroupedByCategory assetsGroupedByCategory) {
		...
		if(assetsGroupedByCategory != null) {
			...
			if(assetsGroupedByCategory.getAssetsOfACategory() == null || assetsGroupedByCategory.getAssetsOfACategory().isEmpty()) {
				return RepositoryServiceClientConstants.FAILURE;
			}else{
	...
	public static String validateGraphRelationship(GraphRelationship graphRelationship) {
		...
		if(RepositoryServiceConsumerUtil.validateAssetKey(graphRelationship.getSourceAsset()).equalsIgnoreCase(RepositoryServiceClientConstants.FAILURE)) {
			return RepositoryServiceClientConstants.FAILURE;
		}
		...
		for (TypedRelationNode typedRelationNode : typedRelationNodes) {
			...
			if(validateGraphRelationship(typedRelationNode.getTarget()).equalsIgnoreCase(RepositoryServiceClientConstants.FAILURE)) {
				return RepositoryServiceClientConstants.FAILURE;
			}
		}
		return RepositoryServiceClientConstants.SUCCESS;
