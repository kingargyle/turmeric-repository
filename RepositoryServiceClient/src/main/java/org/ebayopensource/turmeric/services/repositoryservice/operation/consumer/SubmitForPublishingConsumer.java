...
public class SubmitForPublishingConsumer extends BaseRepositoryServiceConsumer {
	...
	public static String testSubmitForPublishing_validAsset_lockedByUser(AssetInfo assetInfo) {
		...
		try	{
			SubmitForPublishingResponse submitForPublishingResponse = submitForPublishingConsumer.getProxy().submitForPublishing(submitForPublishingRequest);
	...
	public static String testSubmitForPublishing_invalidLogin(AssetInfo assetInfo) 
	{
		...
		submitForPublishingRequest.setComment("Test Comment1");
		try	{
			SubmitForPublishingResponse submitForPublishingResponse = submitForPublishingConsumer.getInvalidProxy().submitForPublishing(submitForPublishingRequest);
			if(submitForPublishingResponse == null) {
				throw new ServiceException(null, "Response object can not be null", null);
			}	
			if(submitForPublishingResponse.getAck().value().equalsIgnoreCase(RepositoryServiceClientConstants.FAILURE)) {							
	...
	public static String testSubmitForPublishing_emptyHeader(AssetInfo assetInfo) 
	{
		...
		submitForPublishingRequest.setComment("Test Comment1");
		try	{
			SubmitForPublishingResponse submitForPublishingResponse = submitForPublishingConsumer.getEmptyProxy().submitForPublishing(submitForPublishingRequest);
			if(submitForPublishingResponse == null) {
				throw new ServiceException(null, "Response object can not be null", null);
			}	
			if(submitForPublishingResponse.getAck().value().equalsIgnoreCase(RepositoryServiceClientConstants.FAILURE)) {							
	...
	public static String testSubmitForPublishing_inValidSession(AssetInfo assetInfo) 
	{
		...
		submitForPublishingRequest.setComment("Test Comment1");
		try	{
			SubmitForPublishingResponse submitForPublishingResponse = submitForPublishingConsumer.getExpiredProxy().submitForPublishing(submitForPublishingRequest);
			if(submitForPublishingResponse == null) {
				throw new ServiceException(null, "Response object can not be null", null);
			}	
			if(submitForPublishingResponse.getAck().value().equalsIgnoreCase(RepositoryServiceClientConstants.FAILURE)) {							
    ...
    protected AsyncTurmericRSV1 getProxy() throws ServiceException {
    	if(service1==null)
    	 	service1 = ServiceFactory.create(RepositoryServiceClientConstants.SERVICE_NAME, RepositoryServiceClientConstants.SERVICE_NAME);
    	
        // get security cookie after first successful login
        if (securityCookie == null) {
            securityCookie = service1.getResponseContext().getTransportHeader(
        ...
        return (AsyncTurmericRSV1) service1.getProxy();
    }
    
    protected TurmericRSV1 getInvalidProxy() throws ServiceException {
    	if(m_proxy == null) {
    ...
    protected TurmericRSV1 getEmptyProxy() throws ServiceException {
    	if(m_proxy == null) {
	        String svcAdminName = RepositoryServiceClientConstants.SERVICE_NAME;
	        Service service = ServiceFactory.create(svcAdminName, RepositoryServiceClientConstants.SERVICE_NAME);
	        RequestContext requestContext = service.getRequestContext();
	        requestContext.setTransportHeader(
                    "X-TURMERIC-SECURITY-COOKIE", "invalidCookie");
    ...
    protected TurmericRSV1 getExpiredProxy() throws ServiceException {
    	if(m_proxy == null) {
	        String svcAdminName = RepositoryServiceClientConstants.SERVICE_NAME;
	        Service service = ServiceFactory.create(svcAdminName, RepositoryServiceClientConstants.SERVICE_NAME);
