...
public class RepositoryListenerConstants 
{
	...
	//public static final String WSDL_VALIDATOR_ASSERTION_SERVICE_LOCATION 	       = "http://crp-soa-04.corp.ebay.com:8080/AssertionsService/AssertionsService";
	...
	public static enum CREDENTIAL_STATUS {SUCCESS,PARTIAL_FAILURE,NOCHANGE};
}
