...
public class UpdateAssetTest {
	...
	public void testUpdateAsset_validAsset_positive() throws Exception {
		try {
			String status = UpdateAssetConsumer
					.testUpdateAsset_validAsset(assetInfo);
	...
	public void testUpdateAsset_validAsset_duplicatename() throws Exception {
		try {
			...
			// this test
			String status = UpdateAssetConsumer
					.testUpdateAsset_validAsset_duplicatename(assetInfo,
							assetInfo2);
	...
	/*
	 * Method under test: updateAsset Test Type : Negative Sub Type :
	 * invalidAsset
	 */
	@Test
	...
	public void testUpdateAsset_invalidVersion() {
		String status = UpdateAssetConsumer
				.testUpdateAsset_invalidVersion(assetInfo);
		Assert.assertEquals(s_success, status);
	}
