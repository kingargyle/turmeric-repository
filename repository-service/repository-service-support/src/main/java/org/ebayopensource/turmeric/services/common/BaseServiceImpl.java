...
public abstract class BaseServiceImpl {
   ...
   /**
    * This method will return the schema validation errors. These validation error are currently stored as warning in
    * MessageContext. This method will convert these errors ( SOA framework erros to ) MarketPlaceErros.
    * 
   ...
   public void addErrorsToResponse(List<CommonErrorData> errors, BaseServiceResponse response) {
