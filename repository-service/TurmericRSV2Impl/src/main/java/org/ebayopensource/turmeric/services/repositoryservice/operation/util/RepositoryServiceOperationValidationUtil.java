...
public class RepositoryServiceOperationValidationUtil {
   ...
   public static boolean validateAssetInfo(AssetInfo assetInfo, List<CommonErrorData> errorDataList) {
      ...
      if (assetInfo != null) {
         ...
         isValid = RepositoryServiceOperationValidationUtil.validateBasicAssetInfo(assetInfo.getBasicAssetInfo(),
                  errorDataList);
         ...
         if (flattenedRelationship != null) {
            isValid = RepositoryServiceOperationValidationUtil.validateFlattenedRelationship(flattenedRelationship,
                     errorDataList);
         }
      } else {
         isValid = false;
   ...
   public static boolean validateAssetInfoForUpdate(AssetInfoForUpdate assetInfoForUpdate,
      ...
      if (assetInfoForUpdate != null) {
         ...
         FlattenedRelationshipForUpdate flattenedRelationshipForUpdate = assetInfoForUpdate
   ...
   public static boolean validateBasicAssetInfo(BasicAssetInfo basicAssetInfo, List<CommonErrorData> errorDataList) {
      ...
      if (basicAssetInfo != null) {
         if (basicAssetInfo.getAssetName() == null
                  && (basicAssetInfo.getAssetKey() == null || basicAssetInfo.getAssetKey().getAssetName() == null)) {
            isValid = false;
         ...
         if (basicAssetInfo.getVersion() == null) {
            ...
            if (!RepositoryServiceValidateUtil.checkVersionFormat(basicAssetInfo.getVersion(), 3)) {
               ...
               errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.INVALID_VERSION,
      ...
      if (artifactInfos == null || artifactInfos.size() <= 0) {
         ...
         for (ArtifactInfo artifactInfo : artifactInfos) {
            if (artifactInfo.getArtifact() != null) {
               ...
               isValid = false;
               errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.ARTIFACT_MISSING,
                        ErrorConstants.ERRORDOMAIN));
            }
   ...
   public static boolean validateFlattenedRelationship(FlattenedRelationship flattenedRelationship,
            List<CommonErrorData> errorDataList) {
      boolean isValid = true;
      ...
      if (flattenedRelationship != null) {
         ...
         if (relatedAssets != null) {
            for (Relation relation : relatedAssets) {
               if (relation.getSourceAsset() != null) {
                  isValid = RepositoryServiceOperationValidationUtil.validateAssetKey(relation.getSourceAsset(),
                           errorDataList);
               }
               if (relation.getAssetRelationship() == null) {
                  isValid = false;
                  errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.RELATIONSHIP_NAME_NOT_ENTERED,
                           ErrorConstants.ERRORDOMAIN));
               }
               ...
               if (targetAsset != null) {
                  ...
                  isValid = false;
                  errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.TARGET_ASSETKEY_MISSING,
                           ErrorConstants.ERRORDOMAIN));
               }
            }
         }
         ...
         isValid = false;
         errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.FLATTENED_RELATIONSHIP_MISSING,
                  ErrorConstants.ERRORDOMAIN));
      }
   ...
   public static boolean validateAssetKey(AssetKey assetKey, List<CommonErrorData> errorDataList) {
      ...
      if (assetKey != null) {
         ...
         errorDataList.add(ErrorDataFactory
                  .createErrorData(ErrorConstants.ASSETKEY_MISSING, ErrorConstants.ERRORDOMAIN));
         isValid = false;
      }
   ...
   public static boolean validateFlattenedRelationshipForUpdate(
            FlattenedRelationshipForUpdate flattenedRelationshipForUpdate, List<CommonErrorData> errorDataList) {
      boolean isValid = true;
      if (flattenedRelationshipForUpdate != null) {
