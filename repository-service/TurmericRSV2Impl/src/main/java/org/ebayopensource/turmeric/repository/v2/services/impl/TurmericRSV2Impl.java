...
public class TurmericRSV2Impl implements TurmericRSV2 {
   ...
   public static void populateProvider() throws ServiceProviderException {
      ...
      if (repositoryServiceProvider == null) {
         String message = " Requested Service Provider is not properly configured in the " + "xml file "
                  + RepositoryServiceConstants.s_providerConfigXml;
   ...
   public CreateCompleteAssetResponse createCompleteAsset(CreateCompleteAssetRequest createCompleteAssetRequest) {
      ...
      try {
         ...
         if (RepositoryServiceValidateUtil.validate(createCompleteAssetRequest, errorDataList)) {
            createCompleteAssetResponse = repositoryServiceProvider.createCompleteAsset(createCompleteAssetRequest);
   ...
   public GetAssetDependenciesResponse getAssetDependencies(GetAssetDependenciesRequest getAssetDependenciesRequest) {
      ...
      try {
         ...
         if (RepositoryServiceValidateUtil.validate(getAssetDependenciesRequest, errorDataList)) {
            getAssetDependenciesResponse = repositoryServiceProvider.getAssetDependencies(getAssetDependenciesRequest);
   ...
   public SearchAssetsDetailedResponse searchAssetsDetailed(SearchAssetsDetailedRequest searchAssetsDetailedRequest) {
      ...
      try {
         ...
         if (RepositoryServiceValidateUtil.validate(searchAssetsDetailedRequest, errorDataList)) {
            searchAssetsDetailedResponse = repositoryServiceProvider.searchAssetsDetailed(searchAssetsDetailedRequest);
   ...
   public SubmitForPublishingResponse submitForPublishing(SubmitForPublishingRequest submitForPublishingRequest) {
      ...
      try {
         ...
         if (RepositoryServiceValidateUtil.validate(submitForPublishingRequest, errorDataList)) {
            submitForPublishingResponse = repositoryServiceProvider.submitForPublishing(submitForPublishingRequest);
            if (submitForPublishingResponse.getErrorMessage() != null) {
               ...
               if (errorDataList.size() > 0) {
                  ...
                  } else if (isWarning && !AckValue.FAILURE.equals(submitForPublishingResponse.getAck())
                           && !AckValue.PARTIAL_FAILURE.equals(submitForPublishingResponse.getAck())) {
   ...
   public UpdateAssetArtifactsResponse updateAssetArtifacts(UpdateAssetArtifactsRequest updateAssetArtifactsRequest) {
      ...
      try {
         ...
         if (RepositoryServiceValidateUtil.validate(updateAssetArtifactsRequest, errorDataList)) {
            updateAssetArtifactsResponse = repositoryServiceProvider.updateAssetArtifacts(updateAssetArtifactsRequest);
   ...
   public static CommonErrorData parseGeneralExceptionMessage(Exception exception) {
      ...
      CommonErrorData errorData = ErrorDataFactory.createErrorData(ErrorConstants.UNKNOWN_EXCEPTION,
               ErrorConstants.ERRORDOMAIN, params);
      return errorData;
   }

   private void handleException(Exception exception, BaseResponse baseResponse, String errorName) {
