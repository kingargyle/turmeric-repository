...
public class RepositoryServiceValidateUtil {
   ...
   public static boolean validate(ApproveAssetRequest approveAssetRequest, List<CommonErrorData> errorDataList) {
      ...
      if (approveAssetRequest.getApprovalInfo() != null) {
         ...
         if (approvalInfo.getApproverRole() == null) {
            errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.APPROVAL_ROLE_MISSING,
         ...
         if (approvalInfo.getAssetId() == null && approvalInfo.getAssetDetail() != null) {
            ...
            if (approvalInfo.getAssetDetail().getAssetName() == null) {
               errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.ASSET_NAME_AND_ID_MISSING,
                        ErrorConstants.ERRORDOMAIN));
            } else if (approvalInfo.getAssetDetail().getAssetType() == null) {
               errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.ASSET_TYPE_MISSING,
                        ErrorConstants.ERRORDOMAIN));
            }
         }

      } else {
         errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.APPROVAL_INFO_MISSING,
                  ErrorConstants.ERRORDOMAIN));
      }
   ...
   public static boolean validate(CreateAndSubmitAssetRequest createAndSubmitAssetRequest,
      ...
      if (createAssetRequest != null) {
         if (createAssetRequest.getBasicAssetInfo() != null) {
            ...
            createAssetRequest.getBasicAssetInfo().getAssetKey().getAssetName() == null)) {
               ...
               if (createAssetRequest.getBasicAssetInfo().getAssetName() == null) {
                  ...
                  createAssetRequest.getBasicAssetInfo().setAssetName(
                           createAssetRequest.getBasicAssetInfo().getAssetKey().getAssetName());
               } else {
                  ...
                  createAssetRequest.getBasicAssetInfo().getAssetKey()
                           .setAssetName(createAssetRequest.getBasicAssetInfo().getAssetName());
               }
            }
            if (createAssetRequest.getBasicAssetInfo().getVersion() == null) {
               isValid = false;
               errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.ASSET_VERSION_MISSING,
                        ErrorConstants.ERRORDOMAIN));
            }
            ...
            if (createAssetRequest.getBasicAssetInfo().getGroupName() == null) {
               ...
               CommonErrorData errorData = ErrorDataFactory.createErrorData(ErrorConstants.GROUP_NOT_PROVIDED,
                        ErrorConstants.ERRORDOMAIN, new String[] { assetName });
            ...
            if (createAssetRequest.getBasicAssetInfo().getVersion() != null) {
               ...
               if (!checkVersionFormat(createAssetRequest.getBasicAssetInfo().getVersion(), 3)) {
                  ...
                  CommonErrorData errorData = ErrorDataFactory.createErrorData(ErrorConstants.INVALID_VERSION,
                           ErrorConstants.ERRORDOMAIN, new String[] { version });
                  errorDataList.add(errorData);
               }
            }
            if (createAssetRequest.getBasicAssetInfo().getAssetKey() == null) {
               isValid = false;
               errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.LIBRARY_ID_MISSING,
                        ErrorConstants.ERRORDOMAIN));
            } else {
               if (createAssetRequest.getBasicAssetInfo().getAssetKey().getAssetId() != null) {
                  errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.ASSET_ID_NOT_NEEDED,
                           ErrorConstants.ERRORDOMAIN));
               }
            }
         } else {
   ...
   public static boolean validate(CreateCompleteAssetRequest createCompleteAssetRequest,
            List<CommonErrorData> errorDataList) {
      boolean isValid = true;

      if (createCompleteAssetRequest != null) {
         isValid = RepositoryServiceOperationValidationUtil.validateAssetInfo(
                  createCompleteAssetRequest.getAssetInfo(), errorDataList);
      } else {
         errorDataList.add(ErrorDataFactory
                  .createErrorData(ErrorConstants.NO_REQUEST_PARAM, ErrorConstants.ERRORDOMAIN));
         isValid = false;
      }
    ...
    * 
    * @param input
    *           The input String to be verified for version pattern compliance.
    * @param level
    *           The number of major and minor versions etc .. for somethng like 1.0 the level is two , and for something
    *           like 1.0.4 the level is 3.
    * @return
    */
   ...
   public static boolean validate(GetAllAssetsGroupedByCategoryRequest getAllAssetsGroupedByCategoryRequest,
            List<CommonErrorData> errorDataList) {
      boolean isValid = true;
   ...
   public static boolean validate(GetAssetDependenciesRequest getAssetDependenciesRequest,
      ...
      if (getAssetDependenciesRequest.getAssetKey() != null) {
         if (getAssetDependenciesRequest.getAssetKey().getAssetId() == null) {
            errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.ASSET_ID_MISSING,
                     ErrorConstants.ERRORDOMAIN));
         }
      } else {
         errorDataList.add(ErrorDataFactory
                  .createErrorData(ErrorConstants.ASSET_ID_MISSING, ErrorConstants.ERRORDOMAIN));
      }
    ...
    * @return
    */
   public static boolean validate(GetAssetInfoRequest getAssetInfoRequest, List<CommonErrorData> errorDataList) {
      boolean isValid = true;
    ...
    * @return
    */
   public static boolean validate(GetAssetStatusRequest getAssetStatusRequest, List<CommonErrorData> errorDataList) {
      boolean isValid = true;
    ...
    */
   public static boolean validate(GetAssetSubmissionPropertiesRequest getAssetSubmissionPropertiesRequest,
            List<CommonErrorData> errorDataList) {
   ...
   public static boolean validate(GetAssetTreeByAttributesRequest getAssetTreeByAttributesRequest,
            List<CommonErrorData> errorDataList) {
      boolean isValid = true;

      if (getAssetTreeByAttributesRequest != null) {
         if (getAssetTreeByAttributesRequest.getNextLevelAttribute() == null
                  || getAssetTreeByAttributesRequest.getNextLevelAttribute().equals("")) {
            isValid = false;
            errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.NEXT_LEVEL_ATTRIBUTE_MISSING,
                     ErrorConstants.ERRORDOMAIN));
         }
      } else {
         isValid = false;
   ...
   public static boolean validate(GetAssetTypesRequest getAssetTypesRequest, List<CommonErrorData> errorDataList) {
    ...
    * @return
    */
   public static boolean validate(GetAssetVersionsRequest getAssetVersionsRequest, List<CommonErrorData> errorDataList) {
      boolean isValid = true;
    ...
    * @return
    */
   public static boolean validate(GetBasicAssetInfoRequest getBasicAssetInfoRequest, List<CommonErrorData> errorDataList) {
      boolean isValid = true;
   ...
   public static boolean validate(LockAssetRequest lockAssetRequest, List<CommonErrorData> errorDataList) {
      boolean isValid = true;
    ...
    * @return
    */
   public static boolean validate(RejectAssetRequest rejectAssetRequest, List<CommonErrorData> errorDataList) {
      boolean isValid = true;
      ...
      if (rejectAssetRequest.getRejectionInfo() != null) {
         ...
         if (rejectionInfo.getRejectionRole() == null) {
            errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.REJECTION_ROLE_MISSING,
                     ErrorConstants.ERRORDOMAIN));
         }
         ...
         errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.REJECTION_INFO_MISSING,
                  ErrorConstants.ERRORDOMAIN));
      }
   ...
   public static boolean validate(RemoveAssetRequest removeAssetRequest, List<CommonErrorData> errorDataList) {
      boolean isValid = true;
   ...
   public static boolean validate(SearchAssetsRequest searchAssetsRequest, List<CommonErrorData> errorDataList) {
      boolean isValid = true;
   ...
   public static boolean validate(SearchAssetsDetailedRequest searchAssetsDetailedRequest,
            List<CommonErrorData> errorDataList) {
      boolean isValid = true;
   ...
   public static boolean validate(SubmitForPublishingRequest submitForPublishingRequest,
      ...
      if (submitForPublishingRequest.getComment() != null && submitForPublishingRequest.getComment().length() > 1000) {
         ...
         CommonErrorData errorData = ErrorDataFactory.createErrorData(ErrorConstants.COMMENT_TOO_LONG,
   ...
   public static boolean validate(UnlockAssetRequest unlockAssetRequest, List<CommonErrorData> errorDataList) {
      boolean isValid = true;
   ...
   public static boolean validate(UpdateAssetArtifactsRequest updateAssetArtifactsRequest,
            List<CommonErrorData> errorDataList) {
      boolean isValid = true;
      if (updateAssetArtifactsRequest != null) {
         ...
         if (updateAssetArtifactsRequest.getArtifactInfo() != null) {
            if (updateAssetArtifactsRequest.getArtifactInfo().size() <= 0) {
               errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.NO_ARTIFACTS_FOR_ADDING,
                        ErrorConstants.ERRORDOMAIN));
            } else {
               for (ArtifactInfo artifactInfo : updateAssetArtifactsRequest.getArtifactInfo()) {
                  if (artifactInfo.getArtifact() != null) {
                     if (artifactInfo.getArtifact().getArtifactName() == null) {
                        errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.ARTIFACT_NAME_MISSING,
                                 ErrorConstants.ERRORDOMAIN));
                     }
                     if (artifactInfo.getArtifact().getArtifactValueType() == null) {
                        errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.ARTIFACT_VALUE_TYPE_MISSING,
                                 ErrorConstants.ERRORDOMAIN));
                     }
                     if (artifactInfo.getArtifact().getArtifactCategory() == null) {
                        errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.ARTIFACT_CATEGORY_MISSING,
                                 ErrorConstants.ERRORDOMAIN));
                     }
                  } else {
                     errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.ARTIFACT_NAME_MISSING,
                  ...
                  if (artifactInfo.getArtifactDetail() == null) {
                     errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.ARTIFACT_EMPTY_EXCEPTION,
                              ErrorConstants.ERRORDOMAIN));
                  }
               }
            }
   ...
   public static boolean validate(UpdateAssetDependenciesRequest updateAssetDependenciesRequest,
            List<CommonErrorData> errorDataList) {
      boolean isValid = true;

      if (updateAssetDependenciesRequest.getAssetKey() == null) {
         isValid = false;
         errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.SOURCE_ASSET_NOT_ENTERED,
                  ErrorConstants.ERRORDOMAIN));
      }

      if (updateAssetDependenciesRequest.getFlattenedRelationshipForUpdate() != null) {
         if (updateAssetDependenciesRequest.getFlattenedRelationshipForUpdate().getSourceAsset() != null
                  && updateAssetDependenciesRequest.getAssetKey() != null) {
            if (updateAssetDependenciesRequest.getFlattenedRelationshipForUpdate().getSourceAsset().getAssetId() == null
                     || !updateAssetDependenciesRequest.getFlattenedRelationshipForUpdate().getSourceAsset()
                              .getAssetId().equals(updateAssetDependenciesRequest.getAssetKey().getAssetId())) {
               isValid = false;
               ...
               errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.ASSET_KEY_MISMATCH_ERROR,
                        ErrorConstants.ERRORDOMAIN));
            }
         } else {
            updateAssetDependenciesRequest.getFlattenedRelationshipForUpdate().setSourceAsset(
         ...
         if (updateAssetDependenciesRequest.getFlattenedRelationshipForUpdate().getRelatedAsset() == null) {
            isValid = false;
            errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.RELATIONS_NOT_ENTERED,
                     ErrorConstants.ERRORDOMAIN));
         } else {
            List<RelationForUpdate> toUpdate = updateAssetDependenciesRequest.getFlattenedRelationshipForUpdate()
                     .getRelatedAsset();
            Iterator<RelationForUpdate> toUpdateItor = toUpdate.iterator();
            while (toUpdateItor.hasNext()) {
               RelationForUpdate relationForUpdate = toUpdateItor.next();
   ...
   private static boolean validateRelationForupdate(RelationForUpdate relationForUpdate,
            List<CommonErrorData> errorDataList) {
      boolean isValid = true;
      if (relationForUpdate.getNewRelation() == null && !relationForUpdate.isDeleteRelation()) {
         ...
         errorParameterList.add(secondAssetKeyErrorParameter);
         errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.NEW_RELATION_MISSING,
                  ErrorConstants.ERRORDOMAIN));
      }
      return isValid;
   }
    ...
    * @return
    */
   public static boolean validate(UpdateAssetRequest updateAssetRequest, List<CommonErrorData> errorDataList) {
      boolean isValid = true;
      ...
      if (updateAssetRequest != null) {
         ...
         if (basicAssetInfo != null) {
            ...
            isValid = false;
            errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.BASE_ASSETINFO_MISSING,
                     ErrorConstants.ERRORDOMAIN));
         }
      } else {
         isValid = false;
   ...
   public static boolean validate(UpdateCompleteAssetRequest updateCompleteAssetRequest,
            List<CommonErrorData> errorDataList) {
      boolean isValid = true;

      if (updateCompleteAssetRequest != null) {
         isValid = RepositoryServiceOperationValidationUtil.validateAssetInfoForUpdate(
                  updateCompleteAssetRequest.getAssetInfoForUpdate(), errorDataList);
      } else {
         errorDataList.add(ErrorDataFactory
                  .createErrorData(ErrorConstants.NO_REQUEST_PARAM, ErrorConstants.ERRORDOMAIN));
         isValid = false;
   ...
   public static boolean validate(ValidateAssetRequest validateAssetRequest, List<CommonErrorData> errorDataList) {
      ...
      if (validateAssetRequest == null) {
         ...
         isValid = false;
         errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.MISSING_ASSETINFO,
                  ErrorConstants.ERRORDOMAIN));
      } else if (validateAssetRequest.getAssetInfo().getBasicAssetInfo() == null
               || validateAssetRequest.getAssetInfo().getBasicAssetInfo().getAssetKey() == null) {
         isValid = false;
         errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.ASSET_NAME_AND_ID_MISSING,
                  ErrorConstants.ERRORDOMAIN));
      }
