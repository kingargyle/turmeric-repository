...
public class RepositoryServiceProviderFactory {
   ...
   private static void populateProviderMap() throws ServiceProviderException {
      ...
      // ClassLoader.getSystemResourceAsStream(RepositoryServiceConstants.s_providerConfigXml);
      InputStream configXmlStream = RepositoryServiceProviderFactory.class.getClassLoader().getResourceAsStream(
      ...
      InputStream serviceProvider = RepositoryServiceProviderFactory.class.getClassLoader().getResourceAsStream(
               RepositoryServiceConstants.s_serviceProviderProperty);
      ...
      List<RepositoryServiceProviders> providerConfig = repositoryServiceConfig.getProviderConfigList()
               .getProviderConfig();
