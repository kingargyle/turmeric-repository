...
/**
 * This creates one of several asset types depending on the information passed to it from the
 * BasicAssetInfo/ArtifactInfo. The asset can the be used during the creation/update/removal process.
 * 
 * @author dcarver
 * 
 */
public class AssetFactory {
    ...
    * 
    * @param basicInfo
    *           A basic asset from the repository service
    * @param registry
    *           A registry implementation from WSO2
    */
