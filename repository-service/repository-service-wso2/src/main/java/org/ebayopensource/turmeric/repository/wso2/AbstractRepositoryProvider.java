...
public abstract class AbstractRepositoryProvider implements RepositoryServiceProvider {
	...
	@Override
	public abstract GetBasicAssetInfoResponse getBasicAssetInfo(
	...
	@Override
	public abstract CreateCompleteAssetResponse createCompleteAsset(
	...
	@Override
	public abstract SubmitForPublishingResponse submitForPublishing(
	...
	@Override
	public abstract GetAssetVersionsResponse getAssetVersions(
			GetAssetVersionsRequest getAssetVersionsRequest);

	@Override
	public abstract UpdateCompleteAssetResponse updateCompleteAsset(
			UpdateCompleteAssetRequest updateCompleteAssetRequest);

	@Override
	public abstract GetAssetStatusResponse getAssetStatus(
	...
	@Override
	public abstract ApproveAssetResponse approveAsset(
			ApproveAssetRequest approveAssetRequest);

	@Override
	public abstract ValidateAssetResponse validateAsset(
			ValidateAssetRequest validateAssetRequest);

	@Override
	public abstract UpdateSubscriptionResponse updateSubscription(
	...
	@Override
	public abstract GetSubscriptionResponse getSubscription(
	...
	@Override
	public abstract SearchAssetsResponse searchAssets(
	...
	@Override
	public abstract GetAssetTypesResponse getAssetTypes(
			GetAssetTypesRequest getAssetTypesRequest);

	@Override
	public abstract GetAssetInfoResponse getAssetInfo(
	 ...
	 */
	protected <T extends BaseResponse> T createErrorMissingAssetName(
	 ...
	 * @return the newly created error response
	 */
	protected <T extends BaseResponse> T createAssetNotFoundError(
	 ...
	 * @return the newly created error response
	 */
	protected <T extends BaseResponse> T createAssetTypeException(
			List<CommonErrorData> errorDataList, T response) {
		errorDataList
	 ...
	 * @return the newly created error response
	 */
	protected <T extends BaseResponse> T createAssetNotLocked(
			List<CommonErrorData> errorDataList,
			T response) {
		errorDataList
	 ...
	 * @return the newly created error response
	 */
	protected <T extends BaseResponse> T createErrorDuplicateAsset(
			List<CommonErrorData> errorDataList, T response) {
	 ...
	 * @return the newly created error response
	 */
	protected <T extends BaseResponse> T createErrorAssetCreation(
			List<CommonErrorData> errorDataList, T response) {
	 ...
	 * @return the newly created error response
	 */
	protected <T extends BaseResponse> T createErrorMissingNamespace(
			List<CommonErrorData> errorDataList, T response) {
		errorDataList
