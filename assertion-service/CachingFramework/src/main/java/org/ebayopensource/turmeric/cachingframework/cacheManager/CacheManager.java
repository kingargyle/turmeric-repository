...
public class CacheManager {
   ...
   public CacheManager(Properties properties, String capsuleClassName) throws IllegalAccessException,
            InstantiationException, ClassNotFoundException, ServiceException {
      if (properties == null) {
    ...
    * 
    * @param libraryName
    *           --> library to wich the asset belongs
    * @param assetName
    *           --> name of the asset to be fetched
    * @param assetVersion
    *           --> version of the asset to be fetched
    * @param assetType
    *           --> assetType of the asset to be fetched
    * @return
    * @throws AssetRetrivalException
    */
   private Object getAssetFromRs(String id, String assetName, String assetVersion, String assetType)
            throws AssetRetrivalException {
      s_logger.debug("username: " + m_properties.getProperty(AssetInfoCapsule.USER_ID) + "password: "
               + m_properties.getProperty(AssetInfoCapsule.PASSWORD));
      ...
      try {
         ...
         throw new AssetRetrivalException(
                  "SecurityException occured while trying to get the constructor object using reflection. Message: "
         ...
         throw new AssetRetrivalException(
                  "NoSuchMethodException occured while trying to get the constructor object using reflection. Message: "
         ...
         throw new AssetRetrivalException(
                  "ClassNotFoundException occured while trying to get the constructor object using reflection. Message: "
                           + classNotFoundException.getMessage(), classNotFoundException);
      }
      try {

         if (assetType.equalsIgnoreCase(ASSET_TYPE_ASSERTION) || assetType.equalsIgnoreCase(ASSET_TYPE_ASSERTION_GROUP)
                  || assetType.equalsIgnoreCase(ASSET_TYPE_ASSERTION_MODULE)) {
         ...
         throw new AssetRetrivalException(
                  "IllegalArgumentException occured while trying to get the assetCapsule object using reflection. Message: "
         ...
         throw new AssetRetrivalException(
                  "InstantiationException occured while trying to get the assetCapsule object using reflection. Message: "
         ...
         throw new AssetRetrivalException(
                  "IllegalAccessException occured while trying to get the assetCapsule object using reflection. Message: "
         ...
         throw new AssetRetrivalException(
                  "InvocationTargetException occured while trying to get the assetCapsule object using reflection. Message: "
                           + invocationTargetException.getMessage(), invocationTargetException);
      }

      Object result = assetCapsule.getAsset(id, assetName, assetVersion, assetType);
      // System.out.println("Method1, AssetType: " + assetType);
      if (assetType.equalsIgnoreCase(ASSET_TYPE_ASSERTION) || assetType.equalsIgnoreCase(ASSET_TYPE_ASSERTION_GROUP)
               || assetType.equalsIgnoreCase(ASSET_TYPE_ASSERTION_MODULE)) {
         // System.out.println("Assertion based asset *************************");
         String key = getKey(id, assetName, assetVersion);
         m_assetCacheMap.put(key, assetCapsule);
         String assetId = assetCapsule.getAssetId();
         String mappingKey = assetId;
   ...
   public Object getAsset(String libraryName, String assetName, String assetVersion, String assetType)
      ...
      if (cachedCapsule == null) {
         ...
         if (asset == null) {
            s_logger.warn("CacheManager: Unable to get AssetCapsule object for the asset: " + assetName + "("
                     + assetVersion + ")belonging to the library: " + libraryName);
         }
      } else {
    ...
    * @throws AssetRetrivalException
    */
   public Object getAsset(String assetId) throws AssetRetrivalException {
      ...
      String assetIdMapingKey = assetId;
      ...
      if (cachedCapsuleKey != null) {
         ...
         asset = cachedCapsule.getAsset(assetId);
      } else {
         asset = getAssetFromRs(assetId);
         if (asset == null) {
    ...
    * @throws AssetRetrivalException
    */
   private Object getAssetFromRs(String assetId) throws AssetRetrivalException {
      s_logger.debug("username: " + m_properties.getProperty(AssetInfoCapsule.USER_ID) + "password: "
               + m_properties.getProperty(AssetInfoCapsule.PASSWORD));
      ...
      Object result = assetCapsule.getAsset(assetId);
      ...
      if (assetType.equalsIgnoreCase(ASSET_TYPE_ASSERTION) || assetType.equalsIgnoreCase(ASSET_TYPE_ASSERTION_GROUP)
         ...
         String assetIdMapingKey = assetId;
         String assetCachekey = getKey(assetId, assetCapsule.getAssetName(), assetCapsule.getAssetVersion());
   ...
   private String getPropertyValue(String fileLocation, String propName) {
      ...
      try {
         InputStream propFileStream = CacheManager.class.getClassLoader().getResourceAsStream(
                  EBAY_SERVICES_FILE_LOCATION);
