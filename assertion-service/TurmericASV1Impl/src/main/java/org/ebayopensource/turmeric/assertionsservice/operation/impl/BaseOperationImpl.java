...
public class BaseOperationImpl {
   ...
   protected boolean validateAssertion(Assertion assertionInput, List<CommonErrorData> errorDataList) {
      ...
      if (assertionInput.getExternalAssertion() != null) {
         ...
         if (externalAssertion.getName() == null) {
            isValid = false;
            errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.ASSERTION_NAME_MISSING,
   ...
   protected boolean validateExternalContent(ExternalContent contentExternal, List<CommonErrorData> errorDataList) {
      ...
      if (contentExternal.getStringContent() != null) {
         ...
         foundContent = true;
         /*
          * if(contentExternal.getStringContent().getContentName() == null) { isValid = false;
      ...
      if (contentExternal.getUrlContent() != null) {
         ...
         foundContent = true;
         /*
          * if(contentExternal.getUrlContent().getContentName() == null) { isValid = false;
          * errorDataList.add(AssertionsServiceErrorDescriptor.ASSERTION_CONTENT_NAME_MISSING.newError()); }
          */
   ...
   protected boolean validateAssertionModule(AssertionModule assertionModule, List<CommonErrorData> errorDataList) {
      ...
      if (assertionModule.getAssertionModuleExternal() != null) {
         ...
         isValid = false;
         errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.MODULE_SCRIPTS_MISSING,
                  ErrorConstants.ERRORDOMAIN));
      }
      return isValid;
   }

   protected boolean validateAssertionModuleAsset(AssertionModuleAsset assetReference,
   ...
   protected boolean validateExternalAssertionModule(ExternalAssertionModule externalAssertionModule,
            List<CommonErrorData> errorDataList) {
      boolean isValid = true;
      ...
      if (externalAssertionModule.getAssertionProcessorType() == null) {
         isValid = false;
         errorDataList.add(ErrorDataFactory.createErrorData(ErrorConstants.ASSERTION_PROCESSOR_TYPE,
                  ErrorConstants.ERRORDOMAIN));
      }
   ...
   protected boolean validateExternalArtifact(ExternalArtifact externalArtifact, List<CommonErrorData> errorDataList) {
      boolean isValid = true;
      // boolean isWarning = false;
      boolean foundContent = false;
      ...
      if (externalArtifact.getTextContent() != null) {
         ...
         foundContent = true;
         /*
          * if(artifactExternal.getTextContent().getContentName() == null) { isValid = false;
          * errorDataList.add(AssertionsServiceErrorDescriptor.ASSERTION_CONTENT_NAME_MISSING.newError()); }
          */
      ...
      if (externalArtifact.getUrlContent() != null) {
         ...
         foundContent = true;
         /*
          * if(artifactExternal.getUrlContent().getContentName() == null) { isValid = false;
          * errorDataList.add(AssertionsServiceErrorDescriptor.ASSERTION_CONTENT_NAME_MISSING.newError()); }
          */
   ...
   protected boolean validateAssertableArtifact(AssertableArtifact assertableArtifact,
            List<CommonErrorData> errorDataList) {
      boolean isValid = true;
      // boolean isWarning = false;
      boolean foundContent = false;
   ...
   protected Object convert(Object inputObject) throws ObjectNotFoundException {
      ...
      if (inputObject.getClass().equals(AssertableArtifact.class)) {
         ...
         if (wsdlAssertableArtifact.getArtifactAssetReference() != null) {
            ...
            if (wsdlArtifactAssetReference != null) {
               apiAssetReference = new org.ebayopensource.turmeric.repositorymanager.assertions.AssetReference(
                        wsdlArtifactAssetReference.getLibraryName(), wsdlArtifactAssetReference.getAssetName(),
                        wsdlArtifactAssetReference.getVersion(), wsdlArtifactAssetReference.getAssetType());
            } else {
            ...
            if (apiAssetReference != null) {
               apiAssetContent = new AssetContent("FILE_PATH", apiAssetReference, wsdlAssertableArtifact
                        .getArtifactAssetReference().getArtifactCategory().value());
            } else {
               new ObjectNotFoundException("Reference to requeried Assertion Asset was not found");
            }
         ...
         org.ebayopensource.turmeric.repositorymanager.assertions.AssetReference apiAssetReference = new org.ebayopensource.turmeric.repositorymanager.assertions.AssetReference(
                  assertionModuleAsset.getLibraryName(), assertionModuleAsset.getAssetName(),
                  assertionModuleAsset.getVersion(), assertionModuleAsset.getAssetType().value());
         ...
         org.ebayopensource.turmeric.repositorymanager.assertions.AssetReference apiAssetReference = new org.ebayopensource.turmeric.repositorymanager.assertions.AssetReference(
                  wsdlAssetReference.getLibraryName(), wsdlAssetReference.getAssetName(),
                  wsdlAssetReference.getVersion(), wsdlAssetReference.getAssetType().value());
         outputObject = apiAssetReference;
         ...
         org.ebayopensource.turmeric.assertion.v1.services.AssertionResultItem wsdlAssertionResultItem = new org.ebayopensource.turmeric.assertion.v1.services.AssertionResultItem();
         ...
         org.ebayopensource.turmeric.assertion.v1.services.AssertionResult wsdlAssertionResult = new org.ebayopensource.turmeric.assertion.v1.services.AssertionResult();
         ...
         if (!apiAssertionResult.getValidationResult().equals(ValidationResult.PASSED)) {
            wsdlAssertionResult
                     .setValidationResult(org.ebayopensource.turmeric.assertion.v1.services.ValidationResult.FAILED);
         } else {
            wsdlAssertionResult
                     .setValidationResult(org.ebayopensource.turmeric.assertion.v1.services.ValidationResult.PASSED);
         }
         ...
         if (apiAssertionResult.getResultItems() != null) {
            for (AssertionResultItem apiAssertionResultItem : apiAssertionResult.getResultItems()) {
               org.ebayopensource.turmeric.assertion.v1.services.AssertionResultItem wsdlAssertionResultItem = (org.ebayopensource.turmeric.assertion.v1.services.AssertionResultItem) convert(apiAssertionResultItem);
         ...
         if (wsdlAssertionModule.getModuleAssetReference() != null) {
            ...
            assetContent = new AssetContent(apiAssetReference.getAssetName(), apiAssetReference,
                     "Assertion Modelue Script");
            assertionContentList.add(assetContent);
            assertionModule = new BasicAssertionModule(apiAssetReference.getAssetName(),
                     apiAssetReference.getVersion(), apiAssetReference.getAssetName(), assertionContentList,
            ...
            assertionModule = new BasicAssertionModule(assertionModuleExternal.getName(),
                     assertionModuleExternal.getVersion(), assertionModuleExternal.getDescription(),
                     assertionContentList, assertionModuleExternal.getAssertionProcessorType().value());
         }
         ...
         if (contentExternal.getBinaryContent() != null) {
            BinaryContent apiBinaryContent = new BinaryContent(ContentBindingName.FILE_PATH.value()/*
                                                                                                    * contentExternal.
                                                                                                    * getBinaryContent
                                                                                                    * ().
                                                                                                    * getContentName()
         ...
         if (contentExternal.getStringContent() != null) {
            StringContent apiStringContent = new StringContent(ContentBindingName.FILE_PATH.value()/*
                                                                                                    * contentExternal.
                                                                                                    * getStringContent
                                                                                                    * ().
                                                                                                    * getContentName()
                                                                                                    */, contentExternal
                     .getStringContent().getContent());

            assertionContent = apiStringContent;
         }
         if (contentExternal.getUrlContent() != null) {
            assertionContent = new URLContent(ContentBindingName.FILE_PATH.value()/*
                                                                                   * contentExternal.getUrlContent().
                                                                                   * getContentName()
                                                                                   */, contentExternal.getUrlContent()
                     .getUrl());
         ...
         if (artifactExternal.getUrlContent() != null) {
            assertionContent = new URLContent(ContentBindingName.FILE_PATH.value()/*
                                                                                   * artifactExternal.getUrlContent().
                                                                                   * getContentName()
                                                                                   */, artifactExternal.getUrlContent()
                     .getUrl());
            // TODO: find how to use the proxy value
