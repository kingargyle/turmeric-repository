...
public class TurmericASV1Impl implements TurmericASV1 {
   ...
   public ApplyAssertionGroupsResponse applyAssertionGroups(ApplyAssertionGroupsRequest applyAssertionGroupsRequest) {
      ...
      ApplyAssertionGroupsOperationImpl applyAssertionGroupsOperationImpl = ApplyAssertionGroupsOperationImpl
               .getInstance();
      if (applyAssertionGroupsOperationImpl.validate(applyAssertionGroupsRequest, errorDataList)) {
         applyAssertionGroupsResponse = applyAssertionGroupsOperationImpl
