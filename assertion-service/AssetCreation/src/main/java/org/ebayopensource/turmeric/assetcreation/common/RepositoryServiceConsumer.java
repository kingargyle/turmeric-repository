...
public class RepositoryServiceConsumer
{
     ...
     *
     * @param createCompAssetReq the create comp asset req
     ...
     *
     * @param basicAssetInfoReq the basic asset info req
     ...
     *
     * @param updateAssetAttrReq the update asset attr req
     ...
     *
     * @param submitAssetRequest the submit asset request
     ...
     *
     * @param updateAssetRequest the update asset request
     ...
     * Lock asset.
     *
     * @param lockAssetRequest the lock asset request
     ...
     * Unlock asset.
     *
     * @param unlockAssetRequest the unlock asset request
     ...
     *
     * @param submitForPubReq the submit for pub req
     ...
     * Removes the asset.
     *
     * @param removeAssetReq the remove asset req
